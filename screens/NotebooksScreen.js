...
const NotebooksScreen = () => {
    ...
    const categories = ["processador", "armazenamento", "marca", "sistema", "status", "local", "memoria", "modelo"];
    ...
    const fetchAllProducts = async () => {
        try {
            ...
            setAllProducts(notebooks); // Store all products
            setFilteredProducts(notebooks); // Initially, show all products
        } catch (error) {
    ...
    const addProduct = async () => {
        ...
        try {
            await setDoc(doc(db, "notebooks", patrimonio), {
                processador,
                memoria,
                armazenamento,
                marca,
            ...
            setFilteredProducts(prevProducts => [
                ...prevProducts,
                { id: patrimonio, processador, memoria, armazenamento, marca, sistema, status, local, patrimonio, modelo, fonte, observacao},
            ]);
    ...
    const editProduct = (item) => {
        ...
        setProcessador(item.processador);
        setMemoria(item.memoria);
    ...
    const updateProduct = async () => {
        ...
        try {
            ...
            // Update Firestore
            const docRef = doc(db, "notebooks", selectedPatrimonio);
                ...
                renderItem={({ item }) => (
                    <View style={styles.card}>
                        <View>
                            ...
                            <Text style={styles.item}>Processador: {item.processador}</Text>
                            <Text style={styles.item}>Memória: {item.memoria}</Text>
                            <Text style={styles.item}>Armazenamento: {item.armazenamento}</Text>
                            <Text style={styles.item}>Marca: {item.marca}</Text>
                            <Text style={styles.item}>Modelo: {item.modelo}</Text>
                            <Text style={styles.item}>Fonte: {item.fonte}</Text>
                            <Text style={styles.item}>Sistema: {item.sistema}</Text>
                        ...
                        >
                            ...
                            >
                                <View style={styles.modalContainer}>
                                    ...
                                    <TextInput style={styles.inputAdd} placeholder="Processador" placeholderTextColor="gray" value={processador} onChangeText={setProcessador} />
                                    <TextInput style={styles.inputAdd} placeholder="Memória" placeholderTextColor="gray" value={memoria} onChangeText={setMemoria} />
                                    <TextInput style={styles.inputAdd} placeholder="Armazenamento" placeholderTextColor="gray" value={armazenamento} onChangeText={setArmazenamento} />
                                    ...
                                    <TextInput style={styles.inputAdd} placeholder="Fonte" placeholderTextColor="gray" value={fonte} onChangeText={setFonte} />
                                    <TextInput style={styles.inputAdd} placeholder="Sistema" placeholderTextColor="gray" value={sistema} onChangeText={setSistema} />
