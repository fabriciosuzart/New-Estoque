...
import MonitoresScreen from "../screens/MonitoresScreen";
import EstabilizadorScreen from "../screens/EstabilizadorScreen";
import NotebooksScreen from "../screens/NotebooksScreen";
import PerifericosScreen from "../screens/PerifericosScreen";
...
export default function StackRoutes() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="ProductListScreen" component={ProductListScreen} options={{ title: "Computadores" }} />
      <Stack.Screen name="MonitoresScreen" component={MonitoresScreen} options={{ title: "Monitores" }} />
      <Stack.Screen name="EstabilizadorScreen" component={EstabilizadorScreen} options={{ title: "Estabilizadores & Nobreak" }} />
      <Stack.Screen name="NotebooksScreen" component={NotebooksScreen} options={{ title: "Notebooks" }} />
      <Stack.Screen name="PerifericosScreen" component={PerifericosScreen} options={{ title: "Periféricos" }} />
